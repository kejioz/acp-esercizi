...
public class Publisher {
	...
	public static void main(String[] args) throws NamingException, JMSException {
		...
		if(args.length < 2){
			System.out.println("WARNING: You need to enter TOPIC-MESSAGE as inpunt, e.g., Soccer Italy-wins");
			return;
		} 
		...
		message.setIntProperty("propInt", 5); // can be used by possible message selectors by subscribers  
		message.setJMSReplyTo(selectedTopic);
