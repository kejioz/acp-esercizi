...
public class Publisher {
	...
	public static void main(String[] args) {
		...
		//QUA E' TUTTO UGUALE PRATICAMENTE, CHIAMO MYTESTTOPIC PIUTTOSTO CHE MYTESTQUEUE
		try{
			
			Context jndiContext = new InitialContext ( jndiProperties); //UGUALE CREO CONTESTO
